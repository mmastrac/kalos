...
kalos_module_export kalos_module_create_handler_export(kalos_module_builder, kalos_function_type type, kalos_module_string name, kalos_int invoke_id, kalos_module_list args);
